...
- [`bitshift-variations-rusted`](https://github.com/Bitshift-Variations-Humanized/bitshift-variations-rusted)
...
## Logo
Simply the two 8-byte strings that define the grand total of two chords used
(Chords? Progressions? Scales? IDK)
